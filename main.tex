...
%		\setlength{\belowcaptionskip}{-2ex}%
	...
	\item We train a neural netork for each of the subblocks, where we use the OpAmp performance as guidance for the DDPM model and train to recover only the sizings of the respective blocks.

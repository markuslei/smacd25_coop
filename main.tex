...
%		\tiny
		...
		\setlength{\abovecaptionskip}{0ex}%
		\setlength{\belowcaptionskip}{2ex}%
		\caption{Estimated mean value and standard deviation of W parameter sizes of the Folded-Cascode OpAmp for 100 samples and same performance specification. It can be seen that the standard deviation varies heavily depending on the device. It is appears that the model learns to scale the effects of parameter deviations.}
